...
export default function SobhaScripts() {
  useEffect(() => {
    // Wait until AOS + GSAP + Swiper are available
    const checkReady = setInterval(() => {
      if (
        ...
        // ✅ AOS init (from your local aos.js)
        window.AOS.init({
          duration: 1200,
        })
        ...
        introTL
          .fromTo(".title-2", { opacity: 0 }, { y: -130, opacity: 1, duration: 2 }, "cat1")
          .to(".title-1", { opacity: 0, duration: 2 }, "cat1")
          .to(".screen-1 img", { scale: 0.55, duration: 2 }, "cat1")
          .fromTo(".jdgs-img img", { y: 200, opacity: 0 }, { y: 0, opacity: 1, duration: 2 }, "cat1")

        introTL.addLabel("cat2", "-=1.1")
          .fromTo(".logo-main", { x: "-100%", opacity: 0 }, { x: "0%", opacity: 1, duration: 2 }, "cat2")
          .fromTo(".menu-sec", { y: "-100%", opacity: 0 }, { y: "0%", opacity: 1, duration: 2 }, "cat2")
          .fromTo(".header-right", { x: "100%", opacity: 0 }, { x: "0%", opacity: 1, duration: 2 }, "cat2")
          .fromTo(".bottom-registration", { y: "100%", opacity: 0 }, { y: "0%", opacity: 1, duration: 2 }, "cat2")
        ...
        window.addEventListener("scroll", () => {
          if (window.scrollY > 0) playIntro()
        })

        // // ===== SWIPER =====
        const swiper = new Swiper(".mastersSwiper", {
          slidesPerView: "auto",
          centeredSlides: true,
          spaceBetween: 30,
          grabCursor: true,
        ...
        const blinkImg = document.querySelector(".light-blink")

        ScrollTrigger.create({
          trigger: ".masters-section",
          start: "top 60%",
          once: true,
          onEnter: () => {
            swiper.slideTo(swiper.slides.length - 1, 800)
  ...
  return (
    <>
      ...
      {/* Lottie */}
      <Script
        src="https://cdnjs.cloudflare.com/ajax/libs/bodymovin/5.12.1/lottie.min.js"
        strategy="afterInteractive"
      />
    </>
  )
