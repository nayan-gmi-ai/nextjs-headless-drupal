...
import { SobhaSpotlight } from "@/components/drupal/SobhaSpotlight"
...
async function getNode(slug: string) {
  ...
  params.include = `
    field_components,
    field_components.field_top_image.field_media_image,
    field_components.field_image_desktop.field_media_image,
    field_components.field_image_mobile.field_media_image,
    field_components.field_card_repeater,
    field_components.field_faq_repeater,
    field_components.field_faq_repeater.field_icon.field_media_image,
    field_components.field_team_members,
    field_components.field_team_members.field_profile_image.field_media_image`
  ;
...
const RESOURCE_TYPES = ["node--components"]
